...
interface MoviesRepository {
    suspend fun getMovieReviews(language: String = "en_US", movieId: String): Result<ArrayList<ReviewEntity>>
    suspend fun getVideosByMovieId(language: String = "en_Us", movieId: String): Result<ArrayList<VideoEntity>>
    suspend fun getSimilarMovies(language: String = "en_US", movieId: String, page: Int = 1): Result<ArrayList<TvShowsEntity>>
    suspend fun getDiscoverMovies(language: String = "en_US", page: Int = 1, withGenresId: String): Result<ArrayList<MovieEntity>>
    suspend fun getMovieDetails(movieId: String, language: String = "en_US"): Result<MovieDetailsEntity>
