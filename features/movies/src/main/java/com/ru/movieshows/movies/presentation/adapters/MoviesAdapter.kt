...
class MoviesAdapter(
    ...
    class MoviesHolder(
        ...
        fun bindView(movie: Movie) {
            ...
            bindMovieNameView(movie)
            bindMovieImageView(movie)
            bindMovieRatingView(movie.rating)
        }
        ...
        private fun bindMovieImageView(movie: Movie) {
        ...
        private fun bindMovieNameView(movie: Movie) {
