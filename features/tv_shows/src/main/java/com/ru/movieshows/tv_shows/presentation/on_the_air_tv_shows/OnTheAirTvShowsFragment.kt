...
import com.ru.movieshows.tvshows.databinding.FragmentOnTheAirTvShowsBinding
...
class OnTheAirTvShowsFragment : BaseFragment() {
    ...
    override val viewModel by viewModels<OnTheAirTvShowsViewModel>()

    private val binding by viewBinding<FragmentOnTheAirTvShowsBinding>()
    ...
    private fun collectState() {
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.onTheAirTvShows.collectLatest { movies ->
