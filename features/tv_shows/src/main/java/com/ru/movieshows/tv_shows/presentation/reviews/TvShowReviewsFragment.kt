...
@AndroidEntryPoint
class TvShowReviewsFragment : BaseFragment() {
    ...
    private val binding by viewBinding<FragmentTvShowReviewsBinding>()
    ...
    ): View = inflater.inflate(R.layout.fragment_tv_show_reviews, container, false)
    ...
    private fun collectState() {
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.tvShowReviews.collectLatest { reviews ->
